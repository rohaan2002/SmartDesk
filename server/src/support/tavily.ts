...
// basically we sanitized tavily results (which gave relevant web search results)
// so that our agent can use them to answer user queries which require web search,
//  without hallucinating or making up information.